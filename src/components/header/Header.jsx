          ...
          <div className="header-intro">
            <div className="flex items-end header-intro-wrapper">
              ...
              <h1 className="header-name text-white">
                Arsyad Gustami, <br /> Frontend Web Developer
              </h1>
            </div>
          ...
          <div className="header-contact">
            <ul className="contact-info-list grid text-white">
              <li className="grid items-start info-item">
                ...
                <p className="info-item-text">
                  Email: <span className="text">arsdev998@gmail.com</span>
                </p>
              </li>
              <li className="grid items-start info-item">
                <span className="info-item-icon">
              ...
              <li className="grid items-start info-item">
                ...
                <p className="info-item-text">
                  Address:{" "}
                  <span className="text">Kalimantan Barat, Indonesia</span>
                </p>
              </li>
              {/* <li className="grid items-start info-item">
                <span className="info-item-icon">
            ...
            <ul className="contact-social-list flex items-center">
              <li className="social-item">
                <a href="https://github.com/Arsdev998" target="_blank">
                  <img src={SkillGithub} />
